    ...
    new string[][]
   {
    ...
    new string[]{"Zuo","做作坐左座昨凿琢撮佐笮酢唑祚胙怍阼柞乍侳咗岝岞挫捽柮椊砟秨稓筰糳繓苲莋葃葄蓙袏諎醋鈼鑿飵嘬阝"}
        ...
        static PinYin()
        {
            ...
            {
                foreach (char c in HanZi[j][1])
                {
                    if (!dict.ContainsKey(c))
                    {
                        dict.Add(c, HanZi[j][0]);
                    }
                    //else TODO: 多音字暂不处理
                }
            }
        ...
        /// <returns></returns>
        public static string GetPinyin(string str, char Digit = char.MinValue, char Other = Char.MinValue)
        {
            StringBuilder rtnSb = new StringBuilder(str.Length);
            ...
            for (int i = 0; i < charary.Length; i++)
            {
                ...
                {
                    rtnSb.Append(dict[ch][0]);
                }
                else
                {
                    rtnSb.Append(char.ToUpper(ch));
                }
            }
        ...
        /// <param name="Other"></param>
        /// <returns></returns>
        public static char GetPinyin(char ch, char Digit = char.MinValue, char Other = Char.MinValue)
        {
